...
function _seed() {
    ...
    const users = {
        'user_current': {
            id: 'user_current', name: 'Yassine Bennani', username: 'yassine_b', initials: 'YB',
            ...
            location: 'Casablanca, Morocco', email: 'yassine.b@email.ma',
        },
        'user_dr_santos': {
            id: 'user_dr_santos', name: 'Dr. Karim El Fassi', username: 'dr_elfassi', initials: 'KE',
            avatar_bg: 'linear-gradient(135deg, #023E8A, #0096C7)',
            bio: 'Board-certified cardiologist with 15 years of experience.',
            specialization: 'Cardiologist', verified: true, joined: '2024-01-10',
            location: 'Rabat, Morocco', email: 'karim.elfassi@chu-rabat.ma',
        },
        'user_nurse_w': {
            id: 'user_nurse_w', name: 'Fatima Zahra Ouali, IDE', username: 'infirmiere_fatima', initials: 'FZ',
            ...
            location: 'Tanger, Morocco', email: 'fatima.ouali@chu-tanger.ma',
        },
        'user_james': {
            id: 'user_james', name: 'Mohamed Amrani', username: 'mohamed_fit', initials: 'MA',
            avatar_bg: 'linear-gradient(135deg, #0077B6, #00B4D8)',
            bio: 'Fitness enthusiast navigating health concerns.',
            specialization: null, verified: false, joined: '2025-02-01',
            location: 'Marrakech, Morocco', email: 'mohamed.a@email.ma',
        },
        'user_sarah': {
            id: 'user_sarah', name: 'Hajar Idrissi', username: 'hajar_sante', initials: 'HI',
            ...
            location: 'Fès, Morocco', email: 'hajar.i@email.ma',
        },
        'user_mike': {
            id: 'user_mike', name: 'Omar Tazi', username: 'omar_tazi', initials: 'OT',
            ...
            location: 'Meknès, Morocco', email: 'omar.t@email.ma',
        },
        'user_dr_patel': {
            id: 'user_dr_patel', name: 'Dr. Amine Cherkaoui, MD', username: 'dr_cherkaoui_eye', initials: 'AC',
            ...
            location: 'Agadir, Morocco', email: 'amine.cherkaoui@chu-agadir.ma',
        },
        'user_anna': {
            id: 'user_anna', name: 'Salma Berrada', username: 'salma_wellness', initials: 'SB',
            ...
            location: 'Oujda, Morocco', email: 'salma.b@email.ma',
        },
    };
    ...
    const comments = [
        ...
        { id: 'cmt_4', postId: 'post_1', userId: 'user_nurse_w', body: "Agree with Dr. El Fassi. I'd also suggest keeping a symptom diary — note the time, duration, intensity, what you ate/drank before exercise, and how long it takes to resolve.", createdAt: now - 30 * 60000, reactions: { thanked: 5, informative: 11 }, isExpert: true },
